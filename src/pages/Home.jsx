...
export default function Home() {
  return (
    ...
    <div className="flex items-center md-opacity-100 opacity-90 justify-center h-screen w-screen m-auto bg-cover bg-gradient-to-r from-blue-900 to-gray-900">
      <div className="min-h-max p-4 font-title bg-transparent bg-opacity-95">
        <div className="flex flex-col justify-center items-center m-8  text-white">
          <h2 className="font-title justify-start text-3xl md:text-6xl ">
            Realiza tu denuncia completamente anónima y segura.
          </h2>
          <br />
